 ...
 * @author Author
 */
public class BabyRedSlobbererAnimation {
	public static final AnimationDefinition move = AnimationDefinition.Builder.withLength(2.5F).looping()
		.addAnimation("oeild", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(1.75F, KeyframeAnimations.posVec(-0.1F, 0.0F, 0.6F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("carapace", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.75F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.7F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("corps", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.75F, KeyframeAnimations.scaleVec(1.2F, 1.0F, 0.9F), AnimationChannel.Interpolations.LINEAR),
