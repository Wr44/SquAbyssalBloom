...
public class BrineAnimation {
	...
	public static final AnimationDefinition stop_attack = AnimationDefinition.Builder.withLength(2.0F)
		.addAnimation("upperBodyParts0", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, -460.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, -370.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, -290.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, -220.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.25F, KeyframeAnimations.degreeVec(0.0F, -160.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(0.0F, -100.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("upperBodyParts15", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, -1040.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
