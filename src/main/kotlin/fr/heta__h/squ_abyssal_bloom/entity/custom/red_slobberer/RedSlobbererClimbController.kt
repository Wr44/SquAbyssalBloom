...
class RedSlobbererClimbController(
    ...
    private fun tickClimbing(obstacleAhead: Boolean) {
        ...
        val remainingHeight = climbTargetY - redSlobberer.y
    ...
    private fun tickCresting(obstacleAhead: Boolean) {
        ...
        val remainingHeight = climbTargetY - redSlobberer.y
        val targetVerticalSpeed = if (remainingHeight > CREST_FINISH_DISTANCE) {
    ...
    private companion object {
        ...
        const val CREST_SPEED_MULTIPLIER = 0.42
        ...
        const val MIN_CREST_SPEED = 0.006
        const val MAX_CREST_SPEED = 0.02
