...
object NautilusArmorEnchantability {
    ...
    fun onModifyDefaultComponents(event: ModifyDefaultComponentsEvent) {
        event.modify(Items.COPPER_NAUTILUS_ARMOR) { builder, _, _ ->
        ...
        event.modify(Items.IRON_NAUTILUS_ARMOR) { builder, _, _ ->
        ...
        event.modify(Items.GOLDEN_NAUTILUS_ARMOR) { builder, _, _ ->
        ...
        event.modify(Items.DIAMOND_NAUTILUS_ARMOR) { builder, _, _ ->
        ...
        event.modify(Items.NETHERITE_NAUTILUS_ARMOR) { builder, _, _ ->
