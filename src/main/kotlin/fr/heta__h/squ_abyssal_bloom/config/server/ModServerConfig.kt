...
object ModServerConfig {
    ...
    val RED_SLOBBERER_DEPOSIT_GROWTH_CHANCE = double("redSlobbererDepositGrowthChance", 0.14, 0.0, 1.0, "Base chance for one existing calcareous deposit to gain an age during a deposit check.")
    val RED_SLOBBERER_NEW_DEPOSIT_CHANCE = double("redSlobbererNewDepositChance", 0.055, 0.0, 1.0, "Base chance to attempt placing a new calcareous deposit during a deposit check.")
    ...
    val RED_SLOBBERER_DECORATION_CHANCE = double("redSlobbererDecorationChance", 1.0, 0.0, 1.0, "Base chance to attempt placing a decoration, scaled by the reef's collective activity and stability.")
    ...
    val BIOLUMINESCENCE_OPPORTUNITY_MEAN_NIGHT_TICKS = int("bioluminescenceOpportunityMeanNightTicks", 72000, 1, 2000000, "Mean number of eligible night ticks between two personal bioluminescence opportunities.")
    val BIOLUMINESCENCE_OPPORTUNITY_MIN_NIGHT_TICKS = int("bioluminescenceOpportunityMinimumNightTicks", 24000, 1, 2000000, "Minimum exponentially sampled delay, in eligible night ticks.")
