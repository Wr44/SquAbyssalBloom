    ...
    fun buildGroups(category: ConfigCategory.Builder) {
        category.group(OptionGroup.createBuilder()
            ...
            .option(ButtonOption.createBuilder()
                ...
                .build())
            .option(serverInt(ModServerConfig.FISH_SCHOOL_NEIGHBOR_COUNT, format = ModUtilities.unitInt("fish")))
            ...
            .option(serverDouble(ModServerConfig.FISH_SCHOOL_NEIGHBOR_FOV_HALF_ANGLE, step = 5.0, format = ModUtilities.unitDouble("degrees", 0)))
            .build())
        ...
        category.group(OptionGroup.createBuilder()
            ...
            .description(OptionDescription.createBuilder()
                ...
                .build())
            .option(serverInt(ModServerConfig.FISH_SCHOOL_ACTIVATION_THRESHOLD, format = ModUtilities.unitInt("fish")))
            .option(serverInt(ModServerConfig.FISH_SCHOOL_DEACTIVATION_THRESHOLD, format = ModUtilities.unitInt("fish")))
        ...
        category.group(OptionGroup.createBuilder()
            ...
            .option(serverDouble(ModServerConfig.FISH_SCHOOL_MAXIMUM_TURN_RATE, step = 0.5, format = ModUtilities.unitDouble("degrees_per_tick", 1)))
