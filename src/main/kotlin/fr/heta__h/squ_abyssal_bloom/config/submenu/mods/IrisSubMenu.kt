...
object IrisSubMenu : AbstractModSubMenu(ModCompat.irisModId ?: "iris") {
    ...
    override fun clientOptions(): List<Option<*>> = listOf(
        Option.createBuilder<Double>()
            ...
            .controller { opt -> DoubleSliderControllerBuilder.create(opt).range(1.0, 3.0).step(0.1).formatValue(ModUtilities.unitDouble("multiplier", 1)) }
            .build(),
        Option.createBuilder<Double>()
            ...
            .controller { opt -> DoubleSliderControllerBuilder.create(opt).range(0.0, 0.4).step(0.01).formatValue(ModUtilities.percentFormat()) }
            .build(),
        Option.createBuilder<Double>()
            ...
            .controller { opt -> DoubleSliderControllerBuilder.create(opt).range(1.0, 3.0).step(0.05).formatValue(ModUtilities.unitDouble("multiplier", 2)) }
            .build(),
        Option.createBuilder<Double>()
        ...
        Option.createBuilder<Double>()
            ...
            .controller { opt -> DoubleSliderControllerBuilder.create(opt).range(0.0, 1.5).step(0.05).formatValue(ModUtilities.unitDouble("multiplier", 2)) }
            .build(),
        Option.createBuilder<Double>()
            ...
            .controller { opt -> DoubleSliderControllerBuilder.create(opt).range(0.05, 0.50).step(0.01).formatValue(ModUtilities.plainDouble(2)) }
            .build()
    )
}
