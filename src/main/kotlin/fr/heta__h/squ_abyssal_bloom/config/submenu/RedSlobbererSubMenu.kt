...
object RedSlobbererSubMenu {
    ...
    fun buildGroups(category: ConfigCategory.Builder) {
        category.group(OptionGroup.createBuilder()
            ...
            .option(serverInt(ModServerConfig.RED_SLOBBERER_DECORATION_MIN_INTERVAL_TICKS, step = 20))
            .option(serverInt(ModServerConfig.RED_SLOBBERER_DECORATION_MAX_INTERVAL_TICKS, step = 20))
            .option(serverInt(ModServerConfig.RED_SLOBBERER_MAX_DECORATIONS))
            .option(serverDouble(ModServerConfig.RED_SLOBBERER_DECORATION_CHANCE, step = 0.005))
