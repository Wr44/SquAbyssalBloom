...
object RedSlobbererSubMenu {
    ...
    fun buildGroups(category: ConfigCategory.Builder) {
        category.group(OptionGroup.createBuilder()
            ...
            .option(serverInt(ModServerConfig.RED_SLOBBERER_MAX_REEF_FISH) { Component.literal("$it poissons") })
            ...
            .option(serverInt(ModServerConfig.RED_SLOBBERER_MAX_CALCAREOUS_DEPOSITS) { Component.literal("$it depots") })
            ...
            .option(serverInt(ModServerConfig.RED_SLOBBERER_MAX_DECORATIONS) { Component.literal("$it decorations") })
            ...
            .option(serverInt(ModServerConfig.RED_SLOBBERER_FISH_REFUGE_CAPACITY) { Component.literal("$it poissons") })
