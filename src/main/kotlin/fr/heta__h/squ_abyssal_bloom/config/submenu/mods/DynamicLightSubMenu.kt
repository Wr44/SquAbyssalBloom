...
object DynamicLightSubMenu : AbstractModSubMenu(ModCompat.dynLightsModId ?: "lambdynlights") {
    ...
    override val headerOption: Option<*> = Option.createBuilder<Boolean>()
        .name(Component.translatable("config.squ_abyssal_bloom.dynamicLightsEnabled"))
        .description(OptionDescription.of(Component.translatable("config.squ_abyssal_bloom.dynamicLightsEnabled.desc")))
        .binding(Binding.generic(true, { ModConfig.dynamicLightsEnabled }, { ModConfig.dynamicLightsEnabled = it }))
